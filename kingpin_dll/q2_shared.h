...
public:
	...
	vector operator *= (float const &o) { this->x *= o; this->y *= o; this->z *= o; return *this; }
	vector operator /= (float const &o) { this->x /= o; this->y /= o; this->z /= o; return *this; }

	vector operator * (float const &o) { vector v = *this; v *= o; return v; }
	vector operator / (float const &o) { vector v = *this; v /= o; return v; }

	vector operator += (vector const &o) { this->x += o.x; this->y += o.y; this->z += o.z; return *this; }
	vector operator -= (vector const &o) { this->x -= o.x; this->y -= o.y; this->z -= o.z; return *this; }
